...
In Kubernetes, containers are **ephemeral**, meaning data inside a container is lost when it restarts. Volumes solve this problem by providing **persistent storage** that exists beyond the lifecycle of containers.
...
A **Persistent Volume (PV)** is a piece of storage in the cluster provisioned by an administrator or dynamically. 
...
This ensures data persists even if Pods restart.
